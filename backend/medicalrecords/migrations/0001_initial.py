# Generated by Django 5.1 on 2024-08-10 20:35
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('values', models.CharField(choices=[('FO', 'FOSIGA-ECAT'), ('SE', 'SOAT'), ('SM', 'SALARIO MINIMO')], max_length=2)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('service', models.ManyToManyField(blank=True, to='medicalrecords.services')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(blank=True, choices=[('P', 'Paciente'), ('M', 'Medico'), ('E', 'Entidad'), ('C', 'Clinica')], max_length=2, null=True)),
                ...
                ('policys', models.ManyToManyField(to='medicalrecords.policy')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('third_entity', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='scheduled_entity', to='medicalrecords.thirds', verbose_name='Tercero Entidad')),
                ('third_medic', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='scheduled_medics', to='medicalrecords.thirds', verbose_name='Tercero Medico')),
                ('third_patient', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='scheduled_patients', to='medicalrecords.thirds', verbose_name='Tercero Paciente')),
            ],
            options={
                'verbose_name': 'Cita',
