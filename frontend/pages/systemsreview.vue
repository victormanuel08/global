            ...
            <tr v-for="(systemsreview, index) in systemsreviews" :key="index">
              <td :class="ui.td">
                <div class="flex items-center justify-center">
                  <UInput v-model="systemsreview.code" @blur="saveItem(index, 'code', systemsreview.code)"
                    class="border rounded p-1 w-14" />
                </div>
              </td>
              <td :class="ui.td">
                <div class="flex items-center justify-center">
                  <UInput v-model="systemsreview.name" @blur="saveItem(index, 'name', systemsreview.name)"
