            ...
            <tr v-for="(service, index) in services" :key="index">
              <td :class="ui.td">
                <div class="flex items-center justify-center">
                  <UInput v-model="service.code" @blur="saveItem(index,'code',service.code)" class="border rounded p-1 w-14" />
                </div>
              </td>
              <td :class="ui.td">
                <div class="flex items-center justify-center">
                  <UInput v-model="service.description" @blur="saveItem(index,'description',service.description)" class="border rounded p-1" />
                </div>
              </td>
              <td :class="ui.td">
                <div class="flex items-center justify-center">
              ...
              <td :class="ui.td">
                <div class="flex items-center justify-center">
                  <UInput v-model="service.amount_soat" @blur="saveItem(index,'amount_soat',service.amount_soat)" class="border rounded p-1" />
                </div>
              </td>
              <td :class="ui.td">
                <div class="flex items-center justify-center">
                  <UInput v-model="service.amount_particular" @blur="saveItem(index,'amount_particular',service.amount_particular)" class="border rounded p-1" />
                </div>
              </td>
              <td :class="ui.td">
                <div class="flex items-center justify-center">
