<template>
    <div>
        ...
        <div class="grid grid-cols-4  md:grid-cols-4">
            ...
            <div class="m-2">
                <label class="block text-sm font-medium text-gray-700">Tercero Clinica:</label>
            ...
            <div class="m-2">
                <label class="block text-sm font-medium text-gray-700">Tercero Conductor:</label>
                <SelectThird :third-type="'P'"  v-model="record.third_driver_full" @change="saveItem(record.id, 'third_driver', record.third_driver_full.id )">
                </SelectThird>
            </div>
            <div class="m-2">
                <label class="block text-sm font-medium text-gray-700">Tercero Medico Clinica:</label>
            ...
            <div class="m-2">
                <label class="block text-sm font-medium text-gray-700">Tercero Entidad:</label>
                <SelectThird :third-type="'E'"  v-model="record.third_entity_full" @change="saveItem(record.id, 'third_driver', record.third_entity_full.id )">
                </SelectThird>
            </div>
        </div>
        ...
        <div class="grid grid-cols-3  md:grid-cols-3" v-if="record.obj" >
        ...
        <div class="grid grid-cols-7  md:grid-cols-7" v-if="record.obj" >
            <div></div>
            <div class="m-5">
